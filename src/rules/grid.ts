import type { SizeCategory } from '../enums/reference.js';
...
/** Фишка на сетке: левый верхний угол и сторона квадрата в клетках. */
...
/** Клетки под фишкой, считая от её левого верхнего угла. */
